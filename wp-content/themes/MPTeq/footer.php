<footer>
    <section class="design">
        <div id="design1">
            ...
            <div class="column" id="contact">
                ...
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/10/Map.png">
            </div>
        </div>
    </section>
    <section class="design">
    ...
    <section class="design">
        <div id="design4">
            ...
            <div id="details">
                <div id="phone">+27 (0) 79 885 2513</div>
                <div id="fax">+27 (0) 86 293 0351</div>
                <div id="email">info@mpteq.com</div>
                <div id="location">
    ...
    <input type="range" id="footer-toggle" class="toggle" min="0" max="3" value="0">
</footer>
</body>
<?php wp_footer()?>